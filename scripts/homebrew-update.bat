...
set LATEST_VERSION_URL=https://sema4.ai/cdn/downloads/action-server/releases/latest/version.txt
...
set DOWNLOAD_URL=https://sema4.ai/cdn/downloads/action-server/releases/%VERSION%/macos64/action-server
